  ...
  return (
    ...
    >
      ...
      >
        <div className="st-header-brand flex min-w-0 flex-1 items-center gap-2">
          ...
          <div className="min-w-0">
            ...
            <span
              className="st-header-chip inline-flex max-w-full items-center gap-1 truncate rounded-full px-2 py-0.5 text-[10px] font-semibold"
              style={{
      ...
      <button
        ...
        className="st-fab st-tap fixed bottom-24 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg"
      ...
      <nav
        className="st-nav-rail st-safe-bottom fixed bottom-0 left-0 right-0 z-30 border-t"
        style={{ background: 'var(--st-nav)', borderColor: 'var(--st-border)' }}
      >
        <div className="relative mx-auto flex max-w-lg items-stretch justify-around px-1 py-1.5">
          <span
          ...
          {navItems.map(({ to, label, icon: Icon, end }) => (
            <NavLink
              ...
              className="st-nav-item st-tap relative flex min-h-[52px] min-w-[56px] flex-col items-center justify-center gap-0.5 rounded-xl px-1 text-[11px] font-bold"
