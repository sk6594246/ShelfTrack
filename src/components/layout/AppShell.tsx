  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="fixed bottom-24 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg transition active:scale-95"
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <button
                  ...
                  className="st-tap flex items-center gap-3 rounded-2xl border p-3 text-left transition active:scale-[0.98]"
                  style={{
                    borderColor: 'var(--st-border)',
